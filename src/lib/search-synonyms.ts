...
export const SEARCH_SYNONYMS: Array<{ pattern: string; keywords: string[] }> = [
  ...
  { pattern: "reizüberflutung", keywords: ["reizverarbeitung", "overload", "reizmanagement", "orientierungscheck"] },
  { pattern: "reizueberflutung", keywords: ["reizverarbeitung", "overload", "reizmanagement", "orientierungscheck"] },
  { pattern: "könnte ich autistisch sein", keywords: ["könnte ich autistisch sein", "diagnostik", "orientierungscheck"] },
  { pattern: "koennte ich autistisch sein", keywords: ["könnte ich autistisch sein", "diagnostik", "orientierungscheck"] },
  { pattern: "bin ich autistisch", keywords: ["könnte ich autistisch sein", "diagnostik", "orientierungscheck"] },
  ...
  { pattern: "kinderdiagnostik", keywords: ["diagnostik", "kinder"] },
  { pattern: "erwachsenendiagnostik", keywords: ["diagnostik", "erwachsene"] },
  { pattern: "keine neuaufnahme", keywords: ["geschlossen", "keine kapazitäten", "nicht verfügbar", "neuaufnahme"] },
  { pattern: "keine freien plätze", keywords: ["geschlossen", "keine kapazitäten", "nicht verfügbar"] },
  { pattern: "ohne freie plätze", keywords: ["geschlossen", "keine kapazitäten", "nicht verfügbar"] },
  ...
  { pattern: "ich bin autistisch", keywords: ["autismusverdacht", "könnte ich autistisch sein", "orientierungscheck"] },
  { pattern: "selbstreflexion autismus", keywords: ["orientierungscheck", "könnte ich autistisch sein"] },
  { pattern: "autismus erwachsene", keywords: ["orientierungscheck", "diagnostik bei erwachsenen"] },
