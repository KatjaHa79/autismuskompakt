...
description: "Das Persönliche Budget ist eine Form der Leistungserbringung für Teilhabeleistungen, kein zusätzliches Einkommen – wie es funktioniert und wofür es infrage kommt."
category: "rechte-antraege"
targetGroups: ["autistische-menschen", "angehoerige"]
updated: 2026-08-26
sources:
  - title: "SGB IX (u. a. §§ 29, 78)"
    url: "https://www.gesetze-im-internet.de/sgb_9_2018/"
---

Zu Eingliederungshilfe und Assistenzleistungen allgemein: [Eingliederungshilfe & Assistenz](/fuer-autistische-menschen/rechte-und-antraege/eingliederungshilfe-und-assistenz/).
...
<!-- TODO_KATJA_CONTENT: Zuständiger Rehabilitationsträger je nach Lebensbereich (z. B. Sozialhilfeträger, Eingliederungshilfeträger) mit Verlinkung auf offizielle Antragsstellen ergänzen. -->
...
<!-- TODO_KATJA_CONTENT: Konkrete Liste ergänzen, sobald verfügbar. -->

## Ablauf

<!-- TODO_KATJA_CONTENT: Verfahrensschritte (Zielvereinbarung, Budgetbemessung, Auszahlung) im Detail ergänzen. -->
...
<!-- TODO_KATJA_CONTENT: Antrags-Checkliste ergänzen, sobald Materialien-Downloads dafür vorliegen. -->
